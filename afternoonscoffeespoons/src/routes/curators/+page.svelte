<script lang="ts">
    ...
    <div class="text-center text-6xl p-4">Curators</div>
		...
		{#each data.curators as curator}
			<div class="col-span-1 card card-hover overflow-hidden max-w-xs">
				<header class="flex justify-around">
					<a href="/curators/movie/{curator.id}" class="title"><img src={curator.avatar} class="bg-black/50 max-w-fill" alt="Post" /></a>
				</header>
